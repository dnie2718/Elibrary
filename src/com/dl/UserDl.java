...
public class UserDl 
{
	...
	public static int generateAndSendEmail(String receiverMailId,String userName,String password) throws AddressException, MessagingException 
	{
		...
		prop.put("mail.smtp.username", "elibrarykeltron@gmail.com");
		prop.put("mail.smtp.password", "keltron1234");
...
//		mailServerProperties.put("mail.smtp.starttls.enable", "true");
		...
		message.setFrom(new InternetAddress("elibrarykeltron@gmail.com"));
		message.setSubject("Sending Mail with pure Java Mail API ");
		/* Mail body with plain Text */
		message.setText("Hello User," 
		        + "\n\n If you read this, means mail sent with Java Mail API is successful " + password);
